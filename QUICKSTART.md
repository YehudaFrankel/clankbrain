...
End Session
```
Claude extracts lessons from the session and saves them. Even if nothing broke, patterns get captured.

**What gets saved:** `lessons.md`, `decisions.md`, `STATUS.md`. The memory files exist now.
