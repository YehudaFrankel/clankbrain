...
function generateClaudeMd(body, lang, fw, conventions) {
  ...
  // Merge imported existing setup — their content goes FIRST as source of truth
  if (body.importExisting) {
    var existing = body.importExisting;
    // Strip file path headers added by folder upload
    existing = existing.replace(/^# --- .+? ---\n\n/gm, '');
    // Put their content at the top, generated content below
    var generated = s;
    s = '# ' + body.projectName + '\n\n';
    ...
    // Skip the project heading from generated since we already have theirs
